...
export default defineConfig({
  shortcuts: [
    ...
    { 'heading-sm': 'text-16px leading-20px md:text-20px md:leading-26px lg:text-24px lg:leading-32px tracking-wide font-archivo' },
    { 'heading-xs': 'text-14px leading-18px md:text-16px md:leading-22px lg:text-18px lg:leading-24px tracking-wide font-archivo' },
